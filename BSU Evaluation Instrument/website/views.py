    ...
    if request.method == 'POST':
        ...
        if resultExist:
            ...
            if resultExist.APS == None:
                ...
                if rateA>3 and rateB>3 and rateC>3 and rateD>3 and rateAPS>3:
                    sentimentResult = "Excellent Performance"
                elif rateA<3 and rateB<3 and rateC<3 and rateD<3 and rateAPS<3:
                ...
                if resultExist.catA>3 and resultExist.catB>3 and resultExist.catC>3 and resultExist.catD>3 and resultExist.APS>3:
                    sentimentResult = "Excellent Performance"
                elif resultExist.catA<3 and resultExist.catB<3 and resultExist.catC<3 and resultExist.catD<3 and resultExist.APS<3:
                    sentimentResult = "Poor Performance"
                else:
                    sentimentResult = "Neutral"
